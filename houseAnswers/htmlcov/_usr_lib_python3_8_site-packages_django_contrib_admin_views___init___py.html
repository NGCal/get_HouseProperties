...
<head>
    ...
    <title>Coverage for /usr/lib/python3.8/site-packages/django/contrib/admin/views/__init__.py: 100%</title>
...
<div id="header">
    <div class="content">
        <h1>Coverage for <b>/usr/lib/python3.8/site-packages/django/contrib/admin/views/__init__.py</b> :
